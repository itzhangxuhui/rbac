...
#main div.top{ width:100%; background:url(http://localhost/rbactest/Public/Admin/Images/main/main_r2_c2.jpg) no-repeat 0 10px; padding:0 0 0 15px; line-height:35px; float:left}
#main div.sec{ width:100%; background:url(http://localhost/rbactest/Public/Admin/Images/main/main_r2_c2.jpg) no-repeat 0 15px; padding:0 0 0 15px; line-height:35px; float:left}
.left{ float:left}
#main div a{ float:left}
#main span.num{  font-size:30px; color:#538ec6; font-family:"Georgia","Tahoma","Arial";}
.left{ float:left}
div.main-tit{ font-size:14px; font-weight:bold; color:#4e4e4e; background:url(http://localhost/rbactest/Public/Admin/Images/main/main_r4_c2.jpg) no-repeat 0 33px; width:100%; padding:30px 0 0 20px; float:left}
div.main-con{ width:100%; float:left; padding:10px 0 0 20px; line-height:36px;}
div.main-corpy{ font-size:14px; font-weight:bold; color:#4e4e4e; background:url(http://localhost/rbactest/Public/Admin/Images/main/main_r6_c2.jpg) no-repeat 0 33px; width:100%; padding:30px 0 0 20px; float:left}
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
  <tr>
    ...
    <span class="time"><strong>上午好！<?php echo ($row["mg_name"]); ?></strong><u>[超级管理员]</u></span>
  ...
  <tr>
    ...
    会员注册：开启<br/>
会员投稿：开启<br/>
会员个数：<font color="#538ec6"><strong>6</strong></font> 人<br/>
